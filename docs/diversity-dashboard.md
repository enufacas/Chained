...
**Last Updated:** 2025-11-25 01:01:42 UTC
...
|------|-------|-------|-----------|------------|--------|
| 1 | `copilot` | 35.8 | 11.7 | 3.85 | ✅ Good |
| 2 | `copilot-swe-agent` | 33.6 | 3.7 | 7.14 | ✅ Good |
...
```
Diversity Score Trend (last 3 data points)
...
```
Innovation % Trend (last 3 data points)
