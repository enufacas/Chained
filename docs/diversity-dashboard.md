...
**Last Updated:** 2025-11-27 01:01:28 UTC
...
|------|-------|-------|-----------|------------|--------|
| 1 | `copilot` | 34.9 | 9.8 | 3.33 | ✅ Good |
| 2 | `copilot-swe-agent` | 33.2 | 3.2 | 6.25 | ✅ Good |
...
```
Diversity Score Trend (last 10 data points)
...
```
Innovation % Trend (last 10 data points)
