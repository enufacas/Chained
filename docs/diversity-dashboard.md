...
**Last Updated:** 2025-11-25 06:22:03 UTC
...
|------|-------|-------|-----------|------------|--------|
| 1 | `copilot` | 35.7 | 11.4 | 3.85 | ✅ Good |
| 2 | `copilot-swe-agent` | 33.6 | 3.6 | 7.14 | ✅ Good |
...
```
Diversity Score Trend (last 4 data points)
...
```
Innovation % Trend (last 4 data points)
