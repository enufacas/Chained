...
**Last Updated:** 2025-11-26 06:21:49 UTC
...
|------|-------|-------|-----------|------------|--------|
| 1 | `copilot` | 35.3 | 10.5 | 3.85 | ✅ Good |
| 2 | `copilot-swe-agent` | 33.5 | 3.4 | 7.14 | ✅ Good |
...
```
Diversity Score Trend (last 8 data points)
...
```
Innovation % Trend (last 8 data points)
