...
**Last Updated:** 2025-11-26 01:02:24 UTC
...
|------|-------|-------|-----------|------------|--------|
| 1 | `copilot` | 35.5 | 10.8 | 3.85 | ✅ Good |
| 2 | `copilot-swe-agent` | 33.5 | 3.5 | 7.14 | ✅ Good |
...
```
Diversity Score Trend (last 7 data points)
...
```
Innovation % Trend (last 7 data points)
