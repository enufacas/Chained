...
class WorkflowActivityReporter:
    ...
    def generate_text_report(self, top_n: int = 20) -> str:
        ...
        lines.append(f"   Created by: @create-botter")
        lines.append("=" * 80)
        lines.append("")
    ...
    def generate_markdown_report(self, top_n: int = 20) -> str:
        ...
        lines.append("---")
        lines.append("")
        lines.append("*Report generated by `tools/workflow-activity-report.py` - Created by @create-botter*")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Workflow Activity Report Generator by @create-botter'
    )
    parser.add_argument(
        '--owner',
